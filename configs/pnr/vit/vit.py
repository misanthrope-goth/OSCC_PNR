...
model = dict(
    ...
    backbone=dict(
        ...
        drop_path_rate=0.2),
    cls_head=dict(type='TimeSformerHead', num_classes=2, in_channels=1024),
...
ann_file_train = 'data/pnr_train.txt'
ann_file_val = 'data/pnr_val.txt'
ann_file_test = 'data/pnr_test.txt'
